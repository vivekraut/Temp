...
const ContCarrierBalPrefix ="CCONTBAL:"
const NoOfLastTxns int = 20

const MedicalCarrier = "Medical"
const PharmacyCarrier = "Pharmacy"
const DentalCarrier = "Dental"

//Claim / Txn stauses
const ClaimProcessed = "Processed"
const ClaimAdjusted = "Adjusted"
const ClaimReviewAdjustment = "Review - Adjustment"
const ClaimReviewContract = "Review – Contract"
const ClaimReviewExLimit = "Review – Exceeds Limit"
...
type CarrierBalance struct {
	CarrierName string `json:"CarrierName"`
	AccumBalance map[string]float64 `json:"AccumBalance"`
}

type ContMemCarrierBalance struct {
	ContractID  string `json:"ContractID"`
	MemberID string `json:"MemberID"`
	CarrierBalances map[string]CarrierBalance  `json:"CarrierBalances"`
}
...
type MemberNContractDetails struct {
	...
	MemContCarrierBal []CarrierBalance `json:"MemContCarrierBal"`
}
